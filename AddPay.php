    ...
    <form method="POST">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="inputBox">
                    <span>city :</span>
                    <input type="text" placeholder="pune" name="city">
                </div>

                <div class="flex">
                    <div class="inputBox">
                        <span>state :</span>
                        <input type="text" placeholder="maharashtra" name="state">
                    </div>
                    <div class="inputBox">
                        <span>zip code :</span>
            ...
            <div class="col">
                ...
                <div class="inputBox">
                    ...
                    <input type="text" placeholder="mr. Depp" name="cardName" required>
                </div>
                <div class="inputBox">
